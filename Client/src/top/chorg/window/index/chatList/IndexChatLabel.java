...
import static top.chorg.kernel.Variable.getAvatar;
...
public abstract class IndexChatLabel extends IPanel {
    ...
    public String storedInputArea = "[]";
    public int targetId;

    public IndexChatLabel(int width, int height, int type, int targetId,
                          String talker, Date msgTime, String lastMsg, int msgAmount) {
        super(width, height, null, new FlowLayout(FlowLayout.CENTER));
        init(width, height, type, targetId, talker, msgTime, lastMsg, msgAmount);
    }

    public void init(int width, int height, int type, int targetId,
        ...
        this.assignAvatar(new IImageIcon(getAvatar(type, targetId)));
    ...
    public void assignInfoPanel(String talkerName, Date msgTime, String lastMsg, int msgAmount) {
        ...
        this.nameLabel.setPreferredSize(new Dimension(width - height - 15 - 48, labelHeight - 1));

        this.timeLabel = new JLabel(msgTime == null ? "" : getTimeDurText(msgTime), JLabel.CENTER);
        ...
        this.msgLabel.setPreferredSize(new Dimension(width - height - 21 - 32, labelHeight - 1));
        ...
        this.numberLabel.setPreferredSize(new Dimension(30, labelHeight - 1));
